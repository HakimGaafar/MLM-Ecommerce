...
import AdminAnalyticsView from "@/app/admin/analytics/AdminAnalyticsView";
...
export default async function AdminAnalyticsPage() {
  ...
  const ui = locale === "ar" ? ar.adminAnalytics : en.adminAnalytics;
  ...
  return (
    <main className="mx-auto w-full max-w-6xl p-8 animate-page-enter" dir={direction}>
      ...
      <AdminAnalyticsView locale={locale} ui={ui} />
    </main>
  );
}
